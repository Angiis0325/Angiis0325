...
> 💕 *"A little bit of code, a lot of creativity, and endless curiosity."*

I'm a **Systems Engineering student** passionate about technology, software development, and learning new things.

I enjoy transforming ideas into projects, solving problems with code, and discovering new technologies along the way. ✨
...
<img src="https://skillicons.dev/icons?i=java,python,js,html,css,mysql,git,github,vscode&theme=light"/>
...
<img src="https://raw.githubusercontent.com/Anmol-Baranwal/Cool-GIFs-For-GitHub/main/assets/pacman.gif" width="180"/>
...
A luxury automotive software project focused on creating a complete digital ecosystem for a premium car company.

### 🛠️ Main Systems

```text
💗 CRM  → Customer Relationship Management
🌸 ERP  → Inventory and Business Management
✨ CMS  → Premium Web Experience
🗄️ DB   → Data Management
```
...
Some of the areas I've explored throughout my Systems Engineering journey:
...
| 🚀 | Improving my GitHub                       |
| ☕  | Surviving university one commit at a time |
